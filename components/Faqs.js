...
const Faqs = () => {
    const faqData = [
        ...
        },
        {
          ...
          answer: `Academy operates around the clock, 24 hours a day, 7 days a week. Our commitment to diversity strengthens our capabilities,
      ...
      return (
        <section className="dark:bg-gray-800 bg-blue-100">
