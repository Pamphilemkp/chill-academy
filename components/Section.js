...
const Section = ()=> {
    return(
        <div className="min-h-screen bg-white dark:bg-gray-700 dark:text-gray-100">
                    ...
                    <div className="container mx-auto space-y-16">
                        <section className="">
                            ...
                            <div className="grid gap-6 my-16 lg:grid-cols-3">
                                <Card className="max-w-sm bg-gray-400 border  rounded-lg shadow dark:bg-gray-800 border-gray-900 dark:border-gray-300 "
                                ...
                                <Card className="max-w-sm bg-gray-400 border border-gray-900 rounded-lg shadow dark:bg-gray-800  dark:border-gray-300 "
                                    imgAlt="Meaningful alt text for an image that is not purely decorative"
                        ...
                        <section>
                            <div className="grid gap-6 lg:grid-cols-3">
                                <div className="overflow-hidden rounded border-gray-900 dark:border-gray-300 lg:flex lg:col-span-3">
                                    <Image width={1000} height={1000} src="https://source.unsplash.com/random/485x365" alt="" className="object-cover w-full h-auto max-h-96 bg-gray-400 dark:bg-gray-500" />
