...
const AboutComponent = () => {
    ...
    return (
      ...
      <div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
        <div className="flex flex-wrap ">
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-10">
            <div className="relative lg:max-w-md">
              ...
              />
              <div className="absolute bottom-0 right-0 z-10 p-8  bg-white border-4 border-blue-500 rounded shadow dark:border-blue-400 lg:-mb-8 lg:-mr-6 sm:p-8 dark:text-gray-300 dark:bg-gray-800">
          ...
          <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
            ...
            <p
              className={`mb-6 text-base leading-7 text-gray-500 dark:text-gray-400 `}
            >
            ...
            <button
              ...
              className="relative px-6 py-3 font-bold text-white group mb-8"
            >
        ...
        <p
          className={`px-6 md:px-4 mb-6 text-base leading-7 text-gray-500 dark:text-gray-400 ${
        ...
        >
          {`
                ...
                here to make sure your project isn't just good but totally amazing.`}{" "}
          <br />
          {` 
